...
class Financial extends BaseList {
  constructor(props) {
    super(props);
  ...
  render() {
    const { isFetching, resourceList, productListData, page, isManager, type, options } = this.props;
    ...
    return (
      <div>
        <nav className='mb20'>
          <Row>
            <Col className='pull-left mr20 width-240'>
              ...
              >
                <Option key="0" defaultValue="0" title="全部"> 全部</Option>
                {resourcesList}
              </Select>
            </Col>

            <Col className='width-240 pull-left'>
