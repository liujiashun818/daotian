    ...
    return (
      <div>
        <Row className="mb20" type="flex" justify="start">
          ...
          <Search onChange={e => this.props.onGuidePriceChange('1', e)} style={styles.width180} />
        ...
        <span className="new-car-programme-vehicle">
          <Table
