!function(e, t) {
  function n(t) {
    var n = y(), o = n.querySelector('h2'), r = n.querySelector('p'),
      a = n.querySelector('button.cancel'), c = n.querySelector('button.confirm');
    if (o.innerHTML = w(t.title).split('\n').join('<br>'), r.innerHTML = w(t.text || '').
    ...
    if (t.imageUrl) {
      ...
      if (t.imageSize) {
        ...
        g && b
          ? (m = g, p = b, f.css({ width: g + 'px', height: b + 'px' }))
          : e.console.error('Parameter imageSize expects value with format WIDTHxHEIGHT, got ' +
          t.imageSize);
      }
      f.setAttribute('style', f.getAttribute('style') + 'width:' + m + 'px; height:' + p + 'px');
    }
    n.setAttribute('data-has-cancel-button', t.showCancelButton), t.showCancelButton
      ? a.style.display = 'inline-block'
      : C(a), t.cancelButtonText && (a.innerHTML = w(t.cancelButtonText)), t.confirmButtonText &&
    (c.innerHTML = w(t.confirmButtonText)), c.style.backgroundColor = t.confirmButtonColor, i(c, t.confirmButtonColor), n.setAttribute('data-allow-ouside-click', t.allowOutsideClick);
    var h = t.doneFunction ? !0 : !1;
    n.setAttribute('data-has-done-function', h), n.setAttribute('data-timer', t.timer);
  }

  function o(e, t) {
    e = String(e).replace(/[^0-9a-f]/gi, ''), e.length < 6 &&
    (e = e[0] + e[0] + e[1] + e[1] + e[2] + e[2]), t = t || 0;
    var n = '#', o, r;
    for (r = 0; 3 > r; r++)o = parseInt(e.substr(2 *
      r, 2), 16), o = Math.round(Math.min(Math.max(0, o + o * t), 255)).toString(16), n += ('00' +
    o).substr(o.length);
    return n;
  }
  ...
  function l() {
    ...
    b(a, 'pulseWarning'), b(a.querySelector('.body'), 'pulseWarningIns'), b(a.querySelector('.dot'), 'pulseWarningIns'), e.onkeydown = M, t.onclick = A, I &&
    I.focus(), z = void 0, clearTimeout(n.timeout);
  }
  ...
  var u = '.sweet-alert', f = '.sweet-overlay', d = ['error', 'warning', 'info', 'success'], m = {
    ...
    return n = 'undefined' != typeof getComputedStyle
      ? parseInt(getComputedStyle(e).getPropertyValue('padding'), 10)
      : parseInt(e.currentStyle.padding), e.style.left = '', e.style.display = 'none', '-' +
    parseInt(t / 2 + n) + 'px';
  }, T = function(e, t) {
    if (+e.style.opacity < 1) {
      t = t || 16, e.style.opacity = 0, e.style.display = 'block';
      var n = +new Date, o = function() {
        e.style.opacity = +e.style.opacity + (new Date - n) / 100, n = +new Date, +e.style.opacity <
        1 && setTimeout(o, t);
      };
      o();
    }
    ...
    var n = +new Date, o = function() {
      e.style.opacity = +e.style.opacity - (new Date - n) / 100, n = +new Date, +e.style.opacity > 0
        ? setTimeout(o, t)
  ...
  e.sweetAlertInitialize = function() {
    ...
    function a(t) {
      ...
      if (-1 !== [9, 13, 32, 27].indexOf(o)) {
        ...
        9 === o ? (r = -1 === a ? w : a === S.length - 1 ? S[0] : S[a +
        1], O(n), r.focus(), i(r, f.confirmButtonColor)) : (r = 13 === o || 32 === o
          ? -1 === a
            ? w
            : void 0
          : 27 !== o || h.hidden || 'none' === h.style.display
            ? void 0
            : h, void 0 !== r && q(r, n));
      }
    }
    ...
    if (void 0 ===
      arguments[0])return e.console.error('sweetAlert expects at least 1 attribute!'), !1;
    var f = r({}, m);
    switch (typeof arguments[0]) {
      ...
      case'object':
        ...
        f.title = arguments[0].title, f.text = arguments[0].text ||
          m.text, f.type = arguments[0].type ||
          m.type, f.allowOutsideClick = arguments[0].allowOutsideClick ||
          m.allowOutsideClick, f.showCancelButton = void 0 !== arguments[0].showCancelButton
          ? arguments[0].showCancelButton
          : m.showCancelButton, f.closeOnConfirm = void 0 !== arguments[0].closeOnConfirm
          ? arguments[0].closeOnConfirm
          : m.closeOnConfirm, f.closeOnCancel = void 0 !== arguments[0].closeOnCancel
          ? arguments[0].closeOnCancel
          : m.closeOnCancel, f.timer = arguments[0].timer ||
          m.timer, f.confirmButtonText = m.showCancelButton
          ? 'Confirm'
          : m.confirmButtonText, f.confirmButtonText = arguments[0].confirmButtonText ||
          m.confirmButtonText, f.confirmButtonColor = arguments[0].confirmButtonColor ||
          m.confirmButtonColor, f.cancelButtonText = arguments[0].cancelButtonText ||
          m.cancelButtonText, f.imageUrl = arguments[0].imageUrl ||
          m.imageUrl, f.imageSize = arguments[0].imageSize ||
          m.imageSize, f.doneFunction = arguments[1] || null;
        break;
      default:
        return e.console.error('Unexpected type of argument! Expected "string" or "object", got ' +
          typeof arguments[0]), !1;
    }
    n(f), s(), c();
    for (var d = y(), p = function(t) {
      var n = t || e.event, r = n.target || n.srcElement, a = 'confirm' === r.className,
        i = g(d, 'visible'),
    ...
    }, v = d.querySelectorAll('button'), b = 0; b <
         v.length; b++)v[b].onclick = p, v[b].onmouseover = p, v[b].onmouseout = p, v[b].onmousedown = p, v[b].onfocus = p;
    A = t.onclick, t.onclick = function(t) {
      var n = t || e.event, o = n.target || n.srcElement, r = d === o, a = k(d, o),
        i = g(d, 'visible'), c = 'true' === d.getAttribute('data-allow-ouside-click');
      !r && !a && i && c && l();
    };
    ...
    'complete' === t.readyState || 'interactive' === t.readyState && t.body
      ...
      : t.attachEvent && t.attachEvent('onreadystatechange', function() {
        'complete' === t.readyState &&
        (t.detachEvent('onreadystatechange', arguments.callee), e.sweetAlertInitialize());
      });
  }();
}(window, document);